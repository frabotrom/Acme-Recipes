...
<acme:form>
	<acme:input-textbox code="chef.amount.form.label.recipe.heading" path="recipe.heading" readonly="true"/>
		...
		<acme:input-url code="chef.amount.form.label.item.info" path="thing.info" readonly="true"/>
		<acme:input-textbox code="chef.amount.form.label.item.description" path="thing.description" readonly="true"/>
		<acme:input-money code="chef.amount.form.label.item.retaiLPrice" path="thing.retailPrice" readonly="true"/>
		...
		<acme:input-textbox code="chef.recipe.form.label.thing.thingType" path="thing.thingType" readonly="true"/>			
